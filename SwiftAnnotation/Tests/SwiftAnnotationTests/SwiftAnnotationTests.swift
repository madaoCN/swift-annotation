...
final class SwiftAnnotationTests: XCTestCase {
    ...
    func testSwiftSyntax() {
        let outputPath = "/Users/liangxiansong/Git4Madao/swift-annotation/SwiftAnnotation/Sources/SwiftAnnotation/SwiftAnnotation_rewirter.swift"
        let outputURL = URL.init(fileURLWithPath: outputPath)
        let sourcePath = "/Users/liangxiansong/Git4Madao/swift-annotation/SwiftAnnotation/Sources/SwiftAnnotation/SwiftAnnotation.swift"
